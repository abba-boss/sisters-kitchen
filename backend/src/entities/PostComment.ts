...
export class PostComment {
  ...
  @ManyToOne(() => PostComment, (c) => c.replies, { nullable:true, onDelete:"CASCADE" }) @JoinColumn({ name:"parentId" }) parent: PostComment;
  @OneToMany(() => PostComment, (c) => c.parent) replies: PostComment[];
